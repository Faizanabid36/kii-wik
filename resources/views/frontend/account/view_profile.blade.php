            ...
            <section id="timeline-card">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title" style="font-size: 33px; font-weight: bold;">PROFILE INFORMATION</h2>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <ul class="activity-timeline timeline-left list-unstyled">
                                        <li>
                                            ...
                                            <div class="timeline-info">
                                                <p class="font-weight-bold" style=" color:#5e50ee">Name</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-info">
                                                <p class="font-weight-bold" style=" color:#5e50ee">Tag Line</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-info">
                                                <p class="font-weight-bold" style=" color:#5e50ee">Location</p>
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-info">
                                                <p class="font-weight-bold" style=" color:#5e50ee">Skills</p>
                                                <span>{{$profile->tag}}</span>
                                            </div>
