                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        ...
                                        <div class="login-footer">
                                            ...
                                            <div class="footer-btn d-inline text-center">
                                                <a href="{{ url('auth/facebook') }}" class="btn btn-facebook" class="btn btn-facebook"><i class="fa fa-facebook"></i></a>
{{--                                                <a href="#" class="btn btn-twitter white"><span class="fa fa-twitter"></span></a>--}}
                                                <a href="{{ url('auth/google') }}" class="btn btn-google"><span class="fa fa-google"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
